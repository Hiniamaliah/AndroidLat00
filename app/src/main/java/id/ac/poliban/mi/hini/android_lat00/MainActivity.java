package id.ac.poliban.mi.hini.android_lat00;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btFirts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Hai Laki Pertama", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btSecond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Hai Laki Kedua", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btThird.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Hai Laki Ketiga", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btForth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Hai Laki Keempat", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
